...
\begin{itemize}
  ...
  \item allocate and delete and release.
...
\begin{itemize}
  ...
  \item Wasteful as can often just leave it there.
  \item Wasteful as only want to write it down once.
\end{itemize}
...
\begin{itemize}
  \item Pointers are mapped firstprivate.
  \item Will be remapped on each target region.
