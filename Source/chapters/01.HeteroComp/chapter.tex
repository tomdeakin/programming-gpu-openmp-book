...
This three level hierarchy is shown in Figure~\ref{fig:target_device}.
...
{A target device is formed of a number of Compute Units (CU). Each of these Compute Units is formed of a number of Processing Elements (PE), which may be able to execute vector (SIMD) instructions.}
\end{figure}
