...
works of Babbage or much later withTuring, but for the sake of brevity, let's start with the era of computing
...
One solution to this problem is for the CPU is to exploit the concurrency in the workflows we run
...
%
%  TGM:  This section needs to be edited to fit with the others.   
%
