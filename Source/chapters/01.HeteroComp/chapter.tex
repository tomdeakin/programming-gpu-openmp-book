...
One solution to this problem is for the CPU to exploit the concurrency in the workflows we run.
...
I will write this section in the style of the other two.

I will show a schematic of a GPU.  The one Tom wrote is OK, but it doesn't bring out the large number of PEs 
in a modern GPU.   So I will be creating a different diagram.
...
The following text comes from Tom's first stab at this content.  I will end up rewriting much of this, but I will use some of it and therefore am 
